...
<section class="content">
    ...
    <div class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
            ...
            <marquee behavior="" direction=""> Résumé des ventes de la journée </marquee>
        </h5>

        <!-- Bouton toggle collapse -->
        <button class="btn btn-sm btn-light text-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseResume" aria-expanded="false" aria-controls="collapseResume">
            <i class="fas fa-chevron-down"></i>
        </button>
    </div>

    <!-- Collapse (par défaut fermé) -->
    <div id="collapseResume" class="collapse">
