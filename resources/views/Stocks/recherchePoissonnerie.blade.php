          ...
          <div class="card">
            ...
            <div class="card-body">
                  ...
                  <form method="GET" action="{{ route('stock.recherchePoissonnerie') }}">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2 mt-3">
                          ...
                          <a href="{{ route('stock.exportPoissonnerieExcel', request()->all()) }}" class="btn btn-primary mb-3" target="_blank">
                              <i class="fas fa-file-excel"></i> Exporter Excel
                          </a>
                      </div>
                      
                      <div class="col-md-2 mt-3">
                        <a href="{{ route('stock.generatePoissonneriePDF', request()->all()) }}" class="btn btn-danger mb-3" target="_blank">
              ...
              <!-- /.col -->
                    ...
                    <h5 class="mt-3"><b> Stock enregistré poissonnerie du {{ date('d/m/Y', strtotime($dateDebut)) }}  au {{ date('d/m/Y', strtotime($dateFin)) }}</b></h5>
