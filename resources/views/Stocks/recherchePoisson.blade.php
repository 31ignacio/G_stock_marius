        ...
        <div class="container-fluid">
                ...
                <div class="card table-responsive">
                    <div class="card-header">
                        <h3 class="card-title">Sortie de stock poissonnerie</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mt-3">
                                <a href="{{ route('sortieDetailPoissonnerie.excel', ['dateDebut' => request('dateDebut'), 'dateFin' => request('dateFin'), 'produit' => request('produit')]) }}"
                            ...
                            <div class="col-md-2 mt-3">
                                <a href="{{ route('sortieDetailPoissonnerie.pdf', ['dateDebut' => request('dateDebut'), 'dateFin' => request('dateFin'), 'produit' => request('produit')]) }}"
                        ...
                        <div id="my-table">
                            ...
                            <h5 class="mt-3"><b> Sortie de stock poissonnerie à la date du
