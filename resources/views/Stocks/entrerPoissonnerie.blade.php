                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="{{ route('stock.actuelPoissonerie') }}" class="btn btn-outline-success mt-3" title="Voir le stock actuel"><i class="fas fa-archive"></i> Stocks actuels</a><br><br>
                        </div>
                        <div class="col-md-2">
                            <!-- Utilisez une colonne de taille moyenne pour aligner les boutons à gauche -->
                            <a href="{{ route('stock.sortiePoissonnerie') }}" class="btn btn-outline-warning mt-3" title="Voir les sorties de stock"><i
                                    ...
                                    role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('stock.updatePoissonnerie', $stock->id) }}"
                                                method="POST">
                                                @csrf
